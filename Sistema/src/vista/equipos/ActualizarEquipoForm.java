 ...
 * @author Fray
 */
public class ActualizarEquipoForm extends javax.swing.JFrame {

    /**
     * Creates new form InsertarClienteForm
     */
    public ActualizarEquipoForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarEquipoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarEquipoForm().setVisible(true);
            }
        });
    }
