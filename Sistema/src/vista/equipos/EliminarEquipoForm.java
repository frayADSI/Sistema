 ...
 * @author Fray
 */
public class EliminarEquipoForm extends javax.swing.JFrame {

    /**
     * Creates new form EliminarClienteForm
     */
    public EliminarEquipoForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarEquipoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarEquipoForm().setVisible(true);
            }
        });
    }
